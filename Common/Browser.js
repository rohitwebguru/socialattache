...
var Browser =
   {
      ...
      init: function()
      {
         ...
         {
            console.log('OnBlur');
            Browser.hasFocus = false;
         }
         window.onfocus = function()
         {
            console.log('OnFocus');
            Browser.hasFocus = true;
         }
      },
      ...
      GetFlashVersion: function()
      {
         ...
         if (navigator.plugins != null && navigator.plugins.length > 0)
         {
            ...
            {
               let swVer2 = navigator.plugins["Shockwave Flash 2.0"] ? " 2.0" : "";
               let flashDescription = navigator.plugins["Shockwave Flash" + swVer2].description;
               ...
               let versionMinor = tempArrayMinor[1] > 0 ? tempArrayMinor[1] : 0;
      ...
      _EnvironmentType: function()
      {
         if (Browser.environmentType == null)
         {
            if (typeof chrome !== 'undefined' && chrome.extension &&
               (chrome.windows ||    // manifest v3
                  // manifest v2...
                  (chrome.extension.getBackgroundPage && chrome.extension.getBackgroundPage() === window)))
            {
               Browser.environmentType = 'BACKGROUND';
            }
            else if (typeof chrome !== 'undefined' && chrome.extension &&
               (chrome.permission ||    // manifest v3
                  // manifest v2...
                  (chrome.extension.getBackgroundPage && chrome.extension.getBackgroundPage() !== window)))
            {
      ...
      IsExtensionV3: function()
      {
         return typeof chrome !== 'undefined' && chrome.runtime != undefined && chrome.runtime.getManifest().manifest_version == 3;
      },
